...
class ASoC:
    ...
    def uploadCollectionFile(self,filepath):
        ...
        url = 'https://cloud.appscan.com/api/v4/FileUpload?fileType=DastPostmanCollectionJson'
    ...
    def createDastScan(self,app_id,file_id,starting_url,scan_name):
        ...
        data["AppId"] = app_id
        data["FullyAutomatic"] = False
        data["TestOnly"] = True
        data["ScanConfiguration"] = {}
        data["ScanConfiguration"]["Target"] = {}
        data["ScanConfiguration"]["Target"]["StartingUrl"] = starting_url
        data["PostmanCollectionFiles"] = {}
        data["PostmanCollectionFiles"]["CollectionJsonFileId"] = file_id
